...
- Запрашивает параметры у пользователя (порт, TLS домен, количество дополнительных пользователей, ad_tag ? не реализованно ⏳)
- Генерирует секреты для пользователей  
